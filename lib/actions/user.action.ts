...
import { QuestionModel, UserModel } from "@/database";
import { GetUserParams, GetUserQuestionsParams, GetUserQuestionsParams } from "@/types/action";
...
> {
  ...
  try {
    ...
    const totalAnswers = await QuestionModel.countDocuments({ author: userId });
